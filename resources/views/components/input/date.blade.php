<div x-data x-init="new Pikaday({ field: $refs.input, format: 'YYYY/MM/DD' })" @change="$dispatch('input', $event.target.value)" class="max-w-lg flex rounded-md shadow-sm">
    ...
    <input {{ $attributes }} x-ref="input" class="rounded-none rounded-r-md flex-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
</div>
